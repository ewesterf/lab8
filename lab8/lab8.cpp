...
void LoadTex(Textures& tex, string filename)
{
...
void MoveCrossbow(PhyriscsSprite& crossbow, int elapsedMS)
{
...
int main()
{
    ...
    for (int i(0); i < ^; i++)
    {
        ...
        balloon.onCollision = [&drawingArrow, &world, &arrow, &balloon, &balloons, &score, &popSound]
